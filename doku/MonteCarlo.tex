...
Die Monte-Carlo-Methode kann zur numerischen Bestimmung von Integralen benutzt werden. Dazu werden in dem Definitionsbereich der zu integrierenden Funktion Zufallsereignisse generiert. Generell kann ausgesagt werden, dass das Integral
...
approximiert werden kann. Der relative Fehler sinkt dabei mit $\frac{1}{N}$. Während für analytisch lösbare Integrale und solche mit kleinen Dimensionen ($\leq 4$) andere Möglichkeiten oft schneller sind, ist die Monte Carlo Methode besonders bei hohen Dimensionen oder sehr komplizierten Integrationsgrenzen verbreitet. \\
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=8cm]{images/integration_poisson.eps}
	\caption{Histogramm durch Zufallsereignisse}
